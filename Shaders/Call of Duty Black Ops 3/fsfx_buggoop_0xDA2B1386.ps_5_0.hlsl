// ---- Created with 3Dmigoto v1.3.16 on Sun Oct 19 23:18:26 2025
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.x = cmp(0.5 < scriptVector0.y);
  r1.y = 1 + -r0.w;
  r1.x = r1.x ? r1.y : r0.w;
  r1.y = saturate(scriptVector0.x * 0.998000026 + 0.00100000005);
  r1.z = 1 + -r1.y;
  ...
  r1.yz = v1.xy * normalTile.xy + r1.yz;
  r1.w = cmp(0 < r1.x);
  r2.x = cmp(0 < refractionAmount);
  r1.w = r1.w ? r2.x : 0;
  r1.yz = normalMap.Sample(bilinearSampler_s, r1.yz).xy;
  if (r1.w != 0) {
